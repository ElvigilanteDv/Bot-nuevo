...
await m.reply(`❀ El bot ${settings.botname} se encuenta desactivado en este chat.\n\n> 『✦』 Un *administrador* puede activarlo con el comando:\n>  *${usedPrefix}bot on*`)
return
}
...
return m.reply(`✐ El comando *${command}* no se encuentra en mi base.\n❀ Usa *${usedPrefix}help* para ver la lista de comandos.`)
}
const comando = m.text.slice(usedPrefix.length);
if (cmdData.isOwner && !global.owner.map(num => num + '@s.whatsapp.net').includes(sender)) return m.reply(`✐ El comando *${command}* no se encuentra en mi base.\n❀ Usa *${usedPrefix}help* para ver la lista de comandos.`)
